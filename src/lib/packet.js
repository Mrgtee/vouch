...
const DISPLAY_KEYWORDS = new Map([
  ...
  ["ai risk controls", "AI risk controls"],
  ["ai-enabled", "AI risk controls"],
  ...
  ["control", "risk control design"],
  ["control design", "risk control design"],
  ["credit", "credit risk analytics"],
  ["controls", "risk control design"],
  ...
  ["data science", "data science collaboration"],
  ["data science collaboration", "data science collaboration"],
  ["documentation", "regulatory audit readiness"],
  ["explainability", "AI explainability controls"],
  ["ai explainability controls", "AI explainability controls"],
  ["financial risk", "financial risk analytics"],
  ...
  ["model monitoring", "model monitoring controls"],
  ["model risk governance", "model risk governance"],
  ["python and sql fluency", "Python and SQL fluency"],
  ...
  ["regulatory", "regulatory audit readiness"],
  ...
  ["risk", "financial risk analytics"],
  ["risk posture", "risk strategy"],
  ...
  ["third-party risk", "third-party risk controls"],
  ["client-service", "client-service analytics"],
  ["client-service analytics", "client-service analytics"],
  ["trade surveillance", "trade surveillance controls"],
  ["trading", "trading risk workflows"],
...
const CANONICAL_KEYWORDS = new Map([
  ...
  ["ai-enabled", "ai risk controls"],
  ["ai-enabled workflows", "ai risk controls"],
  ["ai risk controls", "ai risk controls"],
  ["asset management", "asset management"],
  ["asset-management", "asset management"],
  ...
  ["data science", "data science collaboration"],
  ["data science collaboration", "data science collaboration"],
  ["science", "data science collaboration"],
  ...
  ["model governance", "model risk governance"],
  ["model monitoring", "model monitoring"],
  ["model risk", "model risk governance"],
  ["model risk governance", "model risk governance"],
  ...
  ["python fluency", "python and sql fluency"],
  ["python or sql fluency", "python and sql fluency"],
  ["python and sql fluency", "python and sql fluency"],
  ["sql fluency", "python and sql fluency"],
  ["fluency", "python and sql fluency"],
  ["regulated", "regulatory audit readiness"],
  ["regulated environment", "regulatory audit readiness"],
  ["regulatory", "regulatory audit readiness"],
  ["regulatory exam", "regulatory audit readiness"],
  ["regulatory exams", "regulatory audit readiness"],
  ["regulatory audit readiness", "regulatory audit readiness"],
  ["audit", "regulatory audit readiness"],
  ["audit readiness", "regulatory audit readiness"],
  ["audit-ready", "regulatory audit readiness"],
  ["stress testing", "stress testing"],
  ["risk posture", "risk strategy"],
  ["risk strategy", "risk strategy"],
  ["posture", "risk strategy"],
  ["quality", "data quality"],
  ["third-party risk", "third-party risk"],
  ["trade surveillance", "trade surveillance"],
  ["trading", "trading"],
